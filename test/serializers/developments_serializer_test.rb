...
class DevelopmentsSerializerTest < ActiveSupport::TestCase
  ...
  private
    ...
    def expected_csv
      csv = <<-CSV
id,creator_id,fields,created_at,updated_at,rdv,asofright,ovr55,clusteros,phased,stalled,name,status,desc,project_url,mapc_notes,tagline,address,city,state,zip_code,height,stories,year_compl,prjarea,singfamhu,twnhsmmult,lgmultifam,tothu,gqpop,rptdemp,emploss,estemp,commsf,hotelrms,onsitepark,total_cost,team_membership_count,cancelled,private,fa_ret,fa_ofcmd,fa_indmf,fa_whs,fa_rnd,fa_edinst,fa_other,fa_hotel,other_rate,affordable,team_member_1_name,team_member_1_website,team_member_1_url_template,team_member_1_location,team_member_1_email,team_member_1_abbv,team_member_1_short_name,team_member_1_role
980190962,562391268,{},1970-01-01 00:00:00 UTC,1970-01-01 00:00:00 UTC,,,,,,,Godfrey Hotel,,,,,,505 Washington Street,Boston,MA,02111,,,,,,,,,,,,75,12,,,,1,false,false,,,,,,,,,,,Metropolitan Area Planning Council,http://mapc.org,,\"Boston, MA\",,MAPC,MAPC,landlord
298486374,562391268,{},1970-01-01 00:00:00 UTC,1970-01-01 00:00:00 UTC,,,,,,,Hello,,,,,,It's me / I was wondering if after all the years,you'd like to me,ET,02118,,,,,,,,,,,,1000,200,,,,,false,false,,,,,,,,,,,,,,,,,,
      CSV
    end
    ...
    def expected_header
      %w( id creator_id fields created_at updated_at rdv asofright
       ovr55 clusteros phased stalled name status desc project_url
       mapc_notes tagline address city state zip_code height stories
       year_compl prjarea singfamhu twnhsmmult lgmultifam tothu gqpop
       rptdemp emploss estemp commsf hotelrms onsitepark total_cost
       team_membership_count cancelled private fa_ret fa_ofcmd
       fa_indmf fa_whs fa_rnd fa_edinst fa_other fa_hotel other_rate
       affordable team_member_1_name team_member_1_website
